 ...
 */
public class Scene {
	public ArrayList<Vector3D> lightSources;
	...
	public Scene(List<Polygon> polygons, Vector3D lightPos) {
		...
		//System.out.println(polygons);
		    ...
		    this.lightSources=new ArrayList<>();
      		this.lightSources.add(lightPos);
	...
	public void addLightSource() {
		Vector3D source=new Vector3D((float)(Math.random()-0.5)*2,(float)(Math.random()-0.5)*2,(float)(Math.random()-0.5)*2);
	...
	public void removeLightSource() {
		...
		this.lightSources.remove(lightSources.size()-1);
		}
	}
